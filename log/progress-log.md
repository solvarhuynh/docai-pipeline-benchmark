...
| 2026-09-17 17:32 | Review | A + B | Điều chỉnh định vị Product-first và phân tách Research component | README.md, task-split.md, docs/architecture/*, docs/concepts/*, docs/guides/*, docs/specs/implementation-guide.md, src/docai/*, scripts/run_eda.py, tests/__init__.py | Toàn bộ repo | Done | Invoice/Receipt là Product use case chính; Track A/B là processing backend; Contract/CUAD, evaluation, benchmark, robustness và cost là Research extension; không triển khai model, dataset, API/Dashboard đầy đủ hoặc benchmark thật |
...
## Giai đoạn hiện tại
Giai đoạn 1 — Nền tảng Product và chuẩn bị dữ liệu (Chưa tải dataset; package, schema và scaffold đã sẵn sàng)

## Việc tiếp theo cần làm
Hoàn thiện data/input layer và Product flow Invoice/Receipt theo phase được phê duyệt; khi bắt đầu phase dữ liệu mới tải các bộ dữ liệu cần thiết vào data/raw/, khảo sát bằng notebooks/01-eda.ipynb và scripts/run_eda.py, rồi cập nhật số liệu thực nghiệm vào docs/architecture/data-dictionary.md.
